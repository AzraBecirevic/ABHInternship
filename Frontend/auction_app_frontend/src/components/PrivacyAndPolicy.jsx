...
<h5 className="policySubTitle">Privacy Policies</h5>
<div className="privacyTextDiv">
<p>You may consult this list to find the Privacy Policy for each of the advertising partners of Auction Application.</p>
...
<p>Note that Auction Application has no access to or control over these cookies that are used by third-party advertisers.</p>

</div>

<h5 className="policySubTitle">Third Party Privacy Policies</h5>
<div className="privacyTextDiv">
<p>Auction Application's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </p>
...
<h5 className="policySubTitle">Children's Information</h5>
<div className="privacyTextDiv">
<p>Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.</p>

<p>Auction Application does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>
</div>

<h5 className="policySubTitle">Online Privacy Policy Only</h5>
<div className="privacyTextDiv">
<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Auction Application. This policy is not applicable to any information collected offline or via channels other than this website.</p>

</div>

<h5 className="policySubTitle">Consent</h5>
<div className="privacyTextDiv">
