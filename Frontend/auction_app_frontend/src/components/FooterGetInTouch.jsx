                ...
                <ul className="infoList">
                    ...
                    <li className="infoListLi">
                        <ul className="socMediaList" >
                            <li className="infoItem"><FontAwesomeIcon icon={faFacebook} size={'lg'} onClick={(e)=>this.openWebLink(e, this.facebookLink)} /></li>
                            <li className="infoItem"><FontAwesomeIcon icon={faInstagramSquare} size={'lg'} onClick={(e)=>this.openWebLink(e, this.instagramLink)} /></li>
                            <li className="infoItem"><FontAwesomeIcon icon={faTwitterSquare} size={'lg'} onClick={(e)=>this.openWebLink(e, this.twitterLink)} /></li>
                            <li className="infoItem"><FontAwesomeIcon icon={faGooglePlus} size={'lg'} onClick={(e)=>this.openWebLink(e, this.googleLink)} /></li>
                        </ul>  
                    </li>
                </ul>  
            </div>
